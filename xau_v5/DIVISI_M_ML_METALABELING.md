...
| `M06_LASSO` 🔒 | 4 | 5 | T1 murah | min \|\|y - Xb\|\|^2 + lambda*\|\|b\|\|_1 |
| `M07_RIDGE` 🔒 | 4 | 3 | T1 murah | min \|\|y - Xb\|\|^2 + lambda*\|\|b\|\|_2^2 |
...
| `M11_META_LABELING` | 8 | 20 | T2 sedang | Model primer memberi ARAH. Model sekunder (biner) memutuskan TARUH / TIDAK TA… |
